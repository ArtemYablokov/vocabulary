...
public class SynonymService {
    ...
    public SynonymService(SynonymUtilService synonymUtilService) {
    ...
    public List<IdTuple> coupleSynonymsToIdTuples(Map<String, Collection<Set<Long>>> uniqueSynonymsSets,
